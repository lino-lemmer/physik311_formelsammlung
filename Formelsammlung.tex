...
\maketitle
 	...
 	\section{Interferenz und Beugung}
		...
		\subsection{Auflösungsvermögen optische Instrumente}
			...
			\intertext{für eine Linse gilt die Näherung}
				&=\frac{d}{2f}
			\intertext{spektrales Auflösungsvermögen Prisma}
				\frac{\lambda}{\Delta\lambda}&=d\dod{n}{\lambda}\quad,\text{mit $d=$Grundseite und $\dod{n}{\lambda}=$Dispersion}
			\end{align*}
	...
	\section{Polarisation}
		...
		\intertext{Nun kann man vier Fälle unterscheiden:}
			...
			\phi_x-\phi_y&=n2\pi-\frac{\pi}{2}\quad \land\quad E_{0x}=E_{0y}&&\implies\text{rechtszirkular polarisierte Welle}\\
