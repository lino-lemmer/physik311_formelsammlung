...
\maketitle
	...
	\section{Elektromagnetische Welle}
		...
		\begin{align*}
			v_{\text{ph}}&=\frac{\omega}{k} \qquad \text{wobei} \qquad k = \frac{1}{\lambda} = \frac{n}{l}
		\end{align*}
		...
		\hfill \\
		Der Index $p$ bezeichnet parallel-, $s$ senkrecht-polarisiertes Licht, die Indices $i$, $t$ und $r$ bezeichnen die einfallende, transmittierte und reflektierte Amplitude von $E$:
		\begin{align*}
	...
	\section{Strahlenoptik}
		...
		\subsection{Kugelflächen}
			...
			\intertext{Im Fall einer \textbf{dünnen Linse} erhält man (Linsenschleifergleichung)}
	...
	\subsection{Allgemein:}
 		 Darstellung des Strahlengangs durch Vektor $\begin{pmatrix}r\\\varphi\end{pmatrix}$, wobei 			 $r$ den Abstand und $\varphi$ den Winkel zur optischen Achse bezeichnet.\\
 		 ...
 		 Die Matrizen werden in entgegengesetzter Richtung zum Lichtweg miteinander multipliziert.
